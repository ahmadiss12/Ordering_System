...
export interface IMeClient {
     ...
     * @return OK
     */
    update(body: UpdateProfileRequest): Observable<ProfileResponse>;
    /**
     * @return No Content
     */
...
export class MeClient implements IMeClient {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    protected processGet(response: HttpResponseBase): Observable<ProfileResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    protected processUpdate(response: HttpResponseBase): Observable<ProfileResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     */
    changePassword(body: ChangePasswordRequest): Observable<void> {
        let url_ = this.baseUrl + "/api/me/password";
        url_ = url_.replace(/[?&]$/, "");
...
export interface IPlatformRestaurantsClient {
    /**
     * @return OK
     */
     ...
     * @return Created
     */
    create(body: CreateRestaurantRequest): Observable<CreatedRestaurantResponse>;
    /**
     * @return OK
     */
    setCommission(restaurantId: string, body: SetCommissionRequest): Observable<PlatformRestaurantResponse>;
    /**
     * @return OK
     */
    setListing(restaurantId: string, body: SetListingRequest): Observable<PlatformRestaurantResponse>;
}

@Injectable({
    providedIn: 'root'
})
export class PlatformRestaurantsClient implements IPlatformRestaurantsClient {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     */
    list(): Observable<PlatformRestaurantResponse[]> {
        let url_ = this.baseUrl + "/api/platform/restaurants";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<PlatformRestaurantResponse[]>;
                }
            } else
                return _observableThrow(response_) as any as Observable<PlatformRestaurantResponse[]>;
        }));
    }

    protected processList(response: HttpResponseBase): Observable<PlatformRestaurantResponse[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
            let result200: any = null;
            result200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver) as PlatformRestaurantResponse[];
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<CreatedRestaurantResponse>;
                }
            } else
                return _observableThrow(response_) as any as Observable<CreatedRestaurantResponse>;
        }));
    }

    protected processCreate(response: HttpResponseBase): Observable<CreatedRestaurantResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 201) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
            let result201: any = null;
            result201 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver) as CreatedRestaurantResponse;
            return _observableOf(result201);
            }));
        } else if (status === 400) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
     ...
     */
    setCommission(restaurantId: string, body: SetCommissionRequest): Observable<PlatformRestaurantResponse> {
        let url_ = this.baseUrl + "/api/platform/restaurants/{restaurantId}/commission";
        if (restaurantId === undefined || restaurantId === null)
            throw new globalThis.Error("The parameter 'restaurantId' must be defined.");
        url_ = url_.replace("{restaurantId}", encodeURIComponent("" + restaurantId));
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("put", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processSetCommission(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processSetCommission(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<PlatformRestaurantResponse>;
                }
            } else
    ...
    protected processSetCommission(response: HttpResponseBase): Observable<PlatformRestaurantResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     */
    setListing(restaurantId: string, body: SetListingRequest): Observable<PlatformRestaurantResponse> {
        let url_ = this.baseUrl + "/api/platform/restaurants/{restaurantId}/listing";
        if (restaurantId === undefined || restaurantId === null)
            throw new globalThis.Error("The parameter 'restaurantId' must be defined.");
        url_ = url_.replace("{restaurantId}", encodeURIComponent("" + restaurantId));
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("put", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processSetListing(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processSetListing(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<PlatformRestaurantResponse>;
                }
            } else
    ...
    protected processSetListing(response: HttpResponseBase): Observable<PlatformRestaurantResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export interface IRestaurantSettingsClient {
    /**
     * @return OK
     */
     ...
     * @return OK
     */
    update(body: UpdateRestaurantSettingsRequest): Observable<RestaurantSettingsResponse>;
    /**
     * @return OK
     */
    setAcceptingOrders(body: SetAcceptingOrdersRequest): Observable<RestaurantSettingsResponse>;
}

@Injectable({
    providedIn: 'root'
})
export class RestaurantSettingsClient implements IRestaurantSettingsClient {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     */
    get(): Observable<RestaurantSettingsResponse> {
        let url_ = this.baseUrl + "/api/restaurant/settings";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<RestaurantSettingsResponse>;
                }
            } else
                return _observableThrow(response_) as any as Observable<RestaurantSettingsResponse>;
        }));
    }

    protected processGet(response: HttpResponseBase): Observable<RestaurantSettingsResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
            let result200: any = null;
            result200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver) as RestaurantSettingsResponse;
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
    ...
    protected processUpdate(response: HttpResponseBase): Observable<RestaurantSettingsResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     */
    setAcceptingOrders(body: SetAcceptingOrdersRequest): Observable<RestaurantSettingsResponse> {
        let url_ = this.baseUrl + "/api/restaurant/settings/accepting-orders";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("patch", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processSetAcceptingOrders(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processSetAcceptingOrders(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<RestaurantSettingsResponse>;
                }
            } else
    ...
    protected processSetAcceptingOrders(response: HttpResponseBase): Observable<RestaurantSettingsResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export interface IRestaurantStaffClient {
    /**
     * @return OK
     */
     ...
     * @return OK
     */
    setRole(userId: string, body: SetStaffRoleRequest): Observable<StaffMemberResponse>;
    /**
     * @return No Content
     */
...
export class RestaurantStaffClient implements IRestaurantStaffClient {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    protected processList(response: HttpResponseBase): Observable<StaffMemberResponse[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
            let result200: any = null;
            result200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver) as StaffMemberResponse[];
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
     ...
     */
    setRole(userId: string, body: SetStaffRoleRequest): Observable<StaffMemberResponse> {
        let url_ = this.baseUrl + "/api/restaurant/staff/{userId}/role";
        ...
        return this.http.request("put", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processSetRole(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<StaffMemberResponse>;
                }
            } else
    ...
    protected processSetRole(response: HttpResponseBase): Observable<StaffMemberResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     */
    remove(userId: string): Observable<void> {
        let url_ = this.baseUrl + "/api/restaurant/staff/{userId}";
        if (userId === undefined || userId === null)
            throw new globalThis.Error("The parameter 'userId' must be defined.");
        url_ = url_.replace("{userId}", encodeURIComponent("" + userId));
        url_ = url_.replace(/[?&]$/, "");
...
export interface CreatedRestaurantResponse {
    restaurant: PlatformRestaurantResponse;
...
export interface PlatformRestaurantResponse {
    id: string;
    name: string;
    slug: string;
    phone: string;
